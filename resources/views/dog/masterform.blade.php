...
<div class="form-group row">
    ...
    <div class="col-8">
        <input id="breeder" name="breeder" type="text" class="form-control" value="{{ old('breeder', $dog->breeder) }}">
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-8">
        <input id="owner" name="owner" type="text" class="form-control" value="{{ old('owner', $dog->owner) }}">
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-8">
        ...
        @if($dog->image_url != null)
            <img src="{{'/storage/pedigree-img/thumbnails/' . $dog->image_url}}" alt="Dog Image">
        @endif
    </div>
</div>
